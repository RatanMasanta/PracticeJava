...
public class FairDistributionOfCookies {
    ...
    public static void main(String[] args) {
        ...
        FairDistributionOfCookies fairDistributionOfCookies =
                new FairDistributionOfCookies();
        System.out.println(fairDistributionOfCookies.distributeCookies(cookies, numberOfChildren));
        /*

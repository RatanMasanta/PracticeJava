...
public class SingleNumberII {
     ...
     * @return number which occurs once
     */
     ...
     * @return number which occurs once
     */
    public int singleNumberBitMasking(int[] nums) {
        int ans = 0;
     ...
     * @return number which occurs once
     */
    public int singleNumberMagic(int[] nums) {
        int ones = 0;
        int twos = 0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(singleNumberII.singleNumberBruteForce(nums));
        System.out.println(singleNumberII.singleNumberBitMasking(nums));
        System.out.println(singleNumberII.singleNumberMagic(nums));
    }

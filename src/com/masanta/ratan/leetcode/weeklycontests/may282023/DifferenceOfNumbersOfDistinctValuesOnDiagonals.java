...
public class DifferenceOfNumbersOfDistinctValuesOnDiagonals {
    ...
    public static void main(String[] args) {
        DifferenceOfNumbersOfDistinctValuesOnDiagonals distinctValuesOnDiagonals =
                new DifferenceOfNumbersOfDistinctValuesOnDiagonals();
        int[][] grid = {{1,2,3},{3,1,5},{3,2,1}};
        int[][] result = distinctValuesOnDiagonals.differenceOfDistinctValues(grid);
